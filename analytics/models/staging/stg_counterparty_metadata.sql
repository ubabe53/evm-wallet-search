select
  ...
  nullif(trim(erc4337_entrypoint_deployment_block), '') as erc4337_entrypoint_deployment_block,
  nullif(trim(erc4337_effective_coverage), '') as erc4337_effective_coverage,
  nullif(trim(erc4337_failed_ranges), '') as erc4337_failed_ranges,
  try_cast(erc4337_block_chunk_size as bigint) as erc4337_block_chunk_size,
  try_cast(erc4337_address_batch_size as integer) as erc4337_address_batch_size,
  fetch_status,
  reason_codes,
  coverage_scope,
