...
matched as (
  select
    ...
    counterparties.erc4337_entrypoint_deployment_block as counterparty_erc4337_entrypoint_deployment_block,
    counterparties.erc4337_effective_coverage as counterparty_erc4337_effective_coverage,
    counterparties.erc4337_failed_ranges as counterparty_erc4337_failed_ranges,
    counterparties.erc4337_block_chunk_size as counterparty_erc4337_block_chunk_size,
    counterparties.erc4337_address_batch_size as counterparty_erc4337_address_batch_size,
