...
select
  ...
  any_value(counterparty_erc4337_block_chunk_size) as erc4337_block_chunk_size,
  any_value(counterparty_erc4337_address_batch_size) as erc4337_address_batch_size,
