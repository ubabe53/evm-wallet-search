...
account_evidence_metrics as (
  select
    ...
    max(observation_block_number) as account_evidence_observation_block_number,
    max(observation_block_timestamp) as account_evidence_observation_block_timestamp,
...
select
  ...
  evidence.account_evidence_observation_block_number,
  evidence.account_evidence_observation_block_timestamp,
